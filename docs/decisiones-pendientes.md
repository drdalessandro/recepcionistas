...
| Superposición de agenda: Dos Santos ↔ Conrado | Ambos publican **miércoles 17-20** (agendas de Andrés, 2026-08-13 y 2026-07-26) y hay **un solo consultorio**: el portal ofrece las dos, pero R-07 deja reservar solo una por franja — el segundo paciente elige un horario que después se rechaza. `npm run agenda:check` y el seed lo avisan. Se resuelve moviendo una de las dos franjas (o confirmando que la superposición es deliberada porque nunca coinciden en la práctica). | ⚠️ Confirmar con Andrés |
