...
export const BOTS: DefBot[] = [
  ...
  { name: 'bw-purgar-auditoria', source: 'src/bots/purgar-auditoria.ts', dist: 'dist/bots/purgar-auditoria.js', description: 'Cron: borra los AuditEvent que pasaron su retención (90 días; 10 años la evidencia de una firma).' , cron: '40 4 * * *' /* Diario de madrugada: es borrado masivo y no compite con el horario de atención. Acotado por corrida; si queda trabajo, sigue mañana. */ },
